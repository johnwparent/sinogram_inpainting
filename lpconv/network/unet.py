...
###
### An adaptation of github.com/HastingsGreer/ImageInpainting
###
...
def nvidia_unet(patch_size, depth=3):
    input_ = Input((patch_size[0], patch_size[1], depth))
    input_mask = Input((patch_size[0], patch_size[1], depth))
    skips = []
    output = input_
    mask = input_mask
